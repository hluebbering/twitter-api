...
kable(userDF, escape = F, align = "c") %>%
  kable_material_dark("striped", full_width = F, html_font = "Roboto Condensed") %>% 
...
ragg::agg_png(filename = "assets/static/report4.png", width = 6587, height = 3595, units = "px", res = 900)
plot.weekday
invisible(dev.off())
knitr::include_graphics("assets/static/report4.png")
```
